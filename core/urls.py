...
from . import (
    ...
    calendar_views,
    catalog_v5,
    daily_order_views_v60,
    daily_report_actions_v21,
    daily_report_v8,
    daily_views,
    dia_gallery_v45,
    digikala_views_v40,
...
urlpatterns = [
    ...
    path("sales/<int:day_id>/import-xlsx/", daily_order_views_v60.import_daily_orders, name="daily_order_import"),
    path("sales/<int:day_id>/<int:brand_id>/<int:size_id>/", sale_entry_v60.sale_size, name="sale_size"),
    path("sales/save/", sale_entry_v60.sale_line_save, name="sale_line_save"),
    ...
    path("material-report/<int:block_id>/save/", material_report_v23.material_block_save, name="material_block_save"),
    path("material-report/<int:block_id>/add-model/", material_report_v23.material_block_add_model, name="material_block_add_model"),
    path("material-report/<int:block_id>/apply/", material_report_v23.material_block_apply_materials, name="material_block_apply"),
    path("material-report/<int:block_id>/apply-output/", material_report_v23.material_block_apply_output, name="material_block_apply_output"),
    ...
    path("settings/products/", pricing_v60.settings_products, name="settings_products"),
    path("settings/products/new/", settings_product_v60.settings_product_form, name="settings_product_new"),
    path("settings/products/<int:product_id>/", settings_product_v60.settings_product_form, name="settings_product_edit"),
