...
class ProductCode(models.Model):
    ...
    class Meta: constraints=[models.UniqueConstraint(fields=["brand","code"],name="uniq_brand_code")]
...
class ProductComposition(models.Model):
    ...
    class Meta: constraints=[models.UniqueConstraint(fields=["product","color"],name="uniq_product_color")]
...
class ProductSize(models.Model):
    ...
    active=models.BooleanField(default=True)
    class Meta: constraints=[models.UniqueConstraint(fields=["product","size"],name="uniq_product_size")]

class StockLocation(models.Model):
    HOME="home"; KHORSHID="khorshid"
...
class StockBalance(models.Model):
    ...
    class Meta: constraints=[models.UniqueConstraint(fields=["brand","size","color","location"],name="uniq_stock_balance")]
...
class StockThreshold(models.Model):
    ...
    class Meta: constraints=[models.UniqueConstraint(fields=["brand","size","color"],name="uniq_stock_threshold")]
...
class SaleLine(models.Model):
    ...
    class Meta: constraints=[models.UniqueConstraint(fields=["day","product_size"],name="uniq_day_product_size")]
    @property
...
class InventoryMovement(models.Model):
    PURCHASE="purchase"; SALE="sale"; TRANSFER="transfer"; PRODUCTION="production"; ADJUST="adjust"
...
class Account(models.Model):
    MELAT="melat"; MOFID="mofid"; DIGIKALA="digikala"; PEDRAM="pedram"; TAKVIN="takvin"
...
class MoneyMovement(models.Model):
    TRANSFER="transfer"; EXPENSE="expense"; SETTLEMENT="settlement"; PURCHASE="purchase"; RECEIPT="receipt"
